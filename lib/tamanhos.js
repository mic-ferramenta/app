...
export const ORDEM_TAMANHOS = ["P", "M", "G", "GG", "2GG", "3GG"];
...
// Posição de um tamanho na ordem P/M/G/GG/2GG/3GG (-1 se não estiver
// na lista -- nesse caso quem usa deve jogar pro final).
export function indiceOrdemTamanho(tamanho) {
  return ORDEM_TAMANHOS.indexOf(String(tamanho || "").toUpperCase());
}
